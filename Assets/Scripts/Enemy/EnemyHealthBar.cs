...
public class EnemyHealthBar : MonoBehaviour
{
    ...
    public bool hideWhenFull = false; // Ocultar barra cuando vida est� al 100%
    ...
    void Awake()
    {
        ...
        // Buscar autom�ticamente la barra si no est� asignada
        if (healthBarFill == null)
        {
            ...
            if (healthBarTransform != null)
            {
                ...
                Debug.Log("HealthBar encontrada autom�ticamente en " + gameObject.name);
            }
        }
    }
    ...
    void LateUpdate()
    {
        ...
        if (enemyTransform != null)
        {
            ...
            // Hacer que la barra siempre mire a la c�mara
            if (Camera.main != null)
            {
    ...
    private void UpdateHealthBar(int currentHealth, int maxHealth)
    {
        if (healthBarFill == null)
        {
            Debug.LogWarning("healthBarFill no est� asignado en " + gameObject.name);
            return;
        }
        ...
        // Ocultar/mostrar seg�n configuraci�n
